    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top menu-color" id="menu-color" style="background-color: rgba(255,255,255,.7);">
				...
				<div class="container-fluid p-0">
                    ...
                    <div class="row mt-5 mx-5">
                        <div class="col-md-7" style="text-align: justify;">
                            <span style="font-size: 1.7rem;font-weight: 700;font-family: 'Lato', sans-serif;">Our Services</span><br><br>
							<span style="font-size: 1rem;font-weight: 400;font-family: 'Lato', sans-serif;">As official PT Pertamina Patra Niaga agent, PT Prodigy Energy Resources provides various high-quality products, such as Industrial Biodiesel B30 and MFO.</span><br><br>
                    ...
                    <div class="row mt-5 mb-5 mx-5">
                        ...
                        <div class="col-md-7">
                            ...
                            <span style="font-size: 1.2rem;font-weight: 700;font-family: 'Lato', sans-serif;">High Performance Operation.</span>
							<span style="font-size: 1rem;font-weight: 400;font-family: 'Lato', sans-serif;">Dedicated on-site team to ensure smooth day-to-day operation and promt response.</span><br><br>
                            <span style="font-size: 1.2rem;font-weight: 700;font-family: 'Lato', sans-serif;">Nationwide Services.</span>
							<span style="font-size: 1rem;font-weight: 400;font-family: 'Lato', sans-serif;">Our extensive network and strong knowledge in the industry enables us the provide excellent services nationwide.</span><br><br>
                            <span style="font-size: 1.2rem;font-weight: 700;font-family: 'Lato', sans-serif;">Customization and Adaptability.</span>
                    ...
                    <!-- <div class="row mt-5">
                        <div class="col-md-12 text-center">
                            <span style="font-size: 1.7rem;font-weight: 700;font-family: 'Lato', sans-serif;">Partnership :</span><br><br>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-md-6 text-center">
                            <img src="image/partnership1.png" width="25%" alt="">
                        </div>
                        <div class="col-md-6 text-center">
                            <img src="image/partnership2.png" width="50%" alt="">
                        </div>
                    </div> -->
