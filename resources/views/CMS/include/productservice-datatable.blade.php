<table class="table table-bordered table-striped" id="data-table-productservice">
    <thead>
        <tr>
...
@push('script')
<script>
$("table[id='data-table-productservice']").DataTable({
    "ordering": false,
    "processing": true,
    "serverSide": true,
    "ajax":{
                "url": "{{ route('datatableProductService') }}",
                "dataType": "json",
                "type": "POST",
                "data":{ 
