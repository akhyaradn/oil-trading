                    ...
                    <div class="row">
                        ...
                        <div class="mySlides container-fluid text-center p-0" style="position: relative;">
                            <div class="text-center text-slider-position col-xs-12">
                                <span class="title-text-slider">Fuel Supply</span><br>
                                <span class="title-text-slider">Distributor Nationwide</span><br><br>
                                <span class="content-text-slider">PT Prodigy Energy Resources offers solutions for</span><br>
                                <span class="content-text-slider">fuel distribution for industrial needs so that your</span><br>
